...
public class ResultDTO {
	...
	public ResultDTO(String axisX, String axisY, List<List> result , String...heads) {
		this.heads = heads;
		this.axisX = axisX;
		this.axisY = axisY;
...
//		listData.add(0, lst);
	...
	public void setListData(List<List> listData) {
		this.listData = listData;
	}

	private Object[][] buildArray(List<List> lst) {
		int i = 0;
		int j = 0;
